...
Public Class FormA7800
    ...
    Public Sub New()
        ...
        VersionLabel.Text = "Emulador A7800"
    ...
    Private Async Sub DownloadButton_Click(sender As Object, e As EventArgs) Handles DownloadButton.Click
        Dim Url As String = "https://github.com/7800-devtools/a7800/releases/download/v5.2/a7800-win-v5.2.zip"
    ...
    Private Sub AboutButton_Click(sender As Object, e As EventArgs) Handles AboutButton.Click
        ...
        psi.FileName = "https://7800.8bitdev.org/index.php/Main_Page"
        Try
            Process.Start(psi)
        Catch ex As Exception
