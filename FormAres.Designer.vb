...
Partial Class FormAres
    ...
    Private Sub InitializeComponent()
        ...
        ' DownloadButton
        ' 
        DownloadButton.Location = New Point(278, 110)
        ...
        ' 
        FirmwareDownloadButton.Location = New Point(326, 179)
        ...
        ' FirmwareUrlTextBox
        ' 
        FirmwareUrlTextBox.Location = New Point(15, 179)
        ...
        ' ReleaseSelector
        ' 
        ReleaseSelector.DropDownStyle = ComboBoxStyle.DropDownList
        ReleaseSelector.FormattingEnabled = True
        ReleaseSelector.Items.AddRange(New Object() {"Estável", "Pré-lançamento"})
        ReleaseSelector.Location = New Point(13, 114)
        ReleaseSelector.Margin = New Padding(4, 3, 4, 3)
        ReleaseSelector.Name = "ReleaseSelector"
        ReleaseSelector.Size = New Size(151, 23)
        ReleaseSelector.TabIndex = 6
        ' 
        ' SelectFolderButton
        ' 
        ...
        ' SaveSettingsButton
        ' 
        SaveSettingsButton.Location = New Point(278, 235)
        ...
        ' SelectVersionLabel
        ' 
        SelectVersionLabel.AutoSize = True
        SelectVersionLabel.Location = New Point(15, 96)
        SelectVersionLabel.Margin = New Padding(4, 0, 4, 0)
        SelectVersionLabel.Name = "SelectVersionLabel"
        SelectVersionLabel.Size = New Size(106, 15)
        SelectVersionLabel.TabIndex = 13
        SelectVersionLabel.Text = "Selecione a versão:"
        ' 
        ' FirmwareLinkLabel
        ' 
        FirmwareLinkLabel.AutoSize = True
        FirmwareLinkLabel.Location = New Point(15, 161)
        ...
        Controls.Add(SelectVersionLabel)
    ...
    Friend WithEvents SelectVersionLabel As Label
